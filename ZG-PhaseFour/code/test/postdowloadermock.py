...
import tencentplatform.postdownloader


class PostDownloader(tencentplatform.postdownloader.PostDownloader):

    def __init__(self, taskinfo):
        tencentplatform.postdownloader.PostDownloader.__init__(self, taskinfo)
        self.download_path = './data/post/'

    def bin2json(self, file):
        jsonfile = tencentplatform.postdownloader.PostDownloader.bin2json(self, file)

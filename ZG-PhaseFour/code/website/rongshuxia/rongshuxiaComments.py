...
##############################################################################################
# @class：RongshuxiaComments
# @author：yongjicao
# @date：2016/12/10
# @note：榕树下小说网获取评论的类，继承于SiteComments类
##############################################################################################
class RongshuxiaComments(SiteComments):
    ...
    def process(self, proparam):
        ...
        topicSourceId = re.findall(r'^http://\w+\.rongshuxia\.com/\w+/(\d+).*', proparam.originalurl).__getitem__(0)
